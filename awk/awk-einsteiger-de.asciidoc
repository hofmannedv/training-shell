...
==== Mit Benennung der Zeilennummern ====
...
==== Ohne Benennung der Zeilennummern ====
...
.Nur jede zweite Zeile ausgeben (gerade Zeilennummern) (`output-content-even.awk`)
----
