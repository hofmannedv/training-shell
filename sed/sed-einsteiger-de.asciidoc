...
.Vier Bindestriche nach (jedem) Eintrag einfügen, der `2016-01-10` beinhaltet
----
...
.Optische Trennung zwischen Datumswechseln
----
$ nl logfile | sed -e '/2016-01-10/a---- 2016-01-10 ----' -e '/2016-01-11/a---- 2016-01-11 ----'
     1   2016-01-10 10:45:15 user fho logged in on /dev/tty1
---- 2016-01-10 ----
     2   2016-01-11 08:30:10 user fho logged in on /dev/tty2
---- 2016-01-11 ----
